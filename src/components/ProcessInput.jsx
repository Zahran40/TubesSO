      ...
      {showForm ? (
        <form onSubmit={handleAddProcess} className="bg-slate-50 p-4 rounded-lg border border-slate-300 space-y-4">
          ...
          <div className="flex gap-2 justify-end">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-blue-600 font-medium transition-colors"
            >
              Tambah Proses
            </button>
          </div>
        ...
        <button
          ...
          className="flex items-center gap-2 w-full px-4 py-3 bg-primary text-white rounded-lg hover:bg-blue-600 font-medium transition-colors justify-center"
        >
